...
export default function Header() {
    ...
    const headerClass = classnames(
        'fixed z-20 h-scree bg-blue-dark w-auto md:static',
        {
    ...
    return (
        <header className={headerClass}>
            <div className="container h-screen box-border flex flex-col justify-between overflow-y-auto">
                <div className="top-header">
                    ...
                    <ul className="list-options list-none px-2 my-0  overflwo-y-auto">
